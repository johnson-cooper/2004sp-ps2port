...
- Last fully real-hardware-known-good integration commit: `1d845c3232a67e5774018c405dfff2e4586a9415` (confirmed working great on real PS2 on 2026-09-18). This baseline includes traversal-stable 80x80 terrain / 72x72 loc residency, compact scene allocations, lazy interface materialization, one-slot terrain texturing with water visible, corrected PS2 viewport model picking, the animated local player in normal World3D ordering, an 18-tile camera-facing visibility wedge, and a zero-extra-memory light-blue PS2 scene clear used as the sky.
...
1. Preserve baseline `1d845c3232a67e5774018c405dfff2e4586a9415`: qword-aligned 80x80 terrain / 72x72 loc traversal, compact scene allocations, lazy interfaces, one-slot water texture, corrected picking, animated/occluded local player, normal gameplay UI, the hardware-good radius-18 camera-aware visibility wedge, and the light-blue scene clear.
