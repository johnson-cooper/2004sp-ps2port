...
- Last fully real-hardware-known-good integration commit: `60e120ad716d927d23e52bdf9b94d39e91ce6dac` (confirmed working on real PS2 on 2026-09-16; qword-aligned 4 MiB scene arena with the 2x3 six-tile terrain strip survived beyond T7723 in Lumbridge).
...
- Current terrain finding: the old 4-byte scene-arena alignment made additional terrain residency highly layout-sensitive: the same 2x3 strip crashed around T2193 and an east-edge five-tile layout could fail during world load. With a 16-byte-aligned arena base and qword-aligned bump allocations, the east-edge five-tile layout survived beyond T6855 and the previously failing 2x3 six-tile strip survived beyond T7723. Treat qword alignment as required; next re-test the original 3x3 nine-tile terrain window under the aligned allocator.
