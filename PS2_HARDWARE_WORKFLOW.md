...
- Last fully real-hardware-known-good integration commit: `74e766497ab77cca894dd0e20b8ed436496ca309` (confirmed working on real PS2 on 2026-09-16; qword-aligned 4 MiB scene arena with the full 3x3 nine-tile terrain window survived beyond T9924 in Lumbridge).
...
- Current terrain finding: the old 4-byte scene-arena alignment made additional terrain residency highly layout-sensitive. After changing the PS2 scene arena to a 16-byte-aligned base with qword-aligned bump allocations, the previously failing 2x3 six-tile strip survived beyond T7723 and the original 3x3 nine-tile window that used to fail around T160 survived beyond T9924. Treat qword alignment as required. The final PS2 terrain target is larger than 3x3; increase residency in controlled hardware-tested steps while preserving the aligned allocator and bounded-memory policy.
