...
- Last fully real-hardware-known-good integration commit: `1e9bf79169ad92483f75f91d0ec4c06cea199bb8` (confirmed working on real PS2 on 2026-09-16; qword-aligned 4 MiB scene arena with a 16x16 / 256-slot resident terrain window survived beyond T4488 in Lumbridge with the four-tile draw radius).
...
- Current terrain finding: the old 4-byte scene-arena alignment made additional terrain residency highly layout-sensitive. After changing the PS2 scene arena to a 16-byte-aligned base with qword-aligned bump allocations, the previously failing 2x3 and 3x3 layouts became stable, and a much larger 16x16 resident window also survived beyond T4488. Treat qword alignment as required. The current resident-memory stress target is therefore 16x16; next measure actual view-distance cost separately by increasing the camera-centred draw radius while keeping 16x16 residency fixed.
