...
- Last fully real-hardware-known-good integration commit: `4743014a300fe7fc8e81ce4044b223cad86f1bf6` (confirmed working perfectly on real PS2 on 2026-09-18). This baseline includes the prior hardware-stable scene/memory/render work plus the light-blue scene clear and the first controller-native UX pass: tunable left-stick deadzone/cursor speed/right-stick deadzone, L3 controller settings, D-pad/X context-menu navigation, and Cross forced to RuneScape's normal top/default action.
...
1. Preserve baseline `4743014a300fe7fc8e81ce4044b223cad86f1bf6`: qword-aligned 80x80 terrain / 72x72 loc traversal, compact scene allocations, lazy interfaces, one-slot water texture, corrected picking, animated/occluded local player, normal gameplay UI, radius-18 camera-aware visibility, the light-blue scene clear, and the hardware-good controller-native settings/context-menu/primary-action controls.
