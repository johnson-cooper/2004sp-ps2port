...
- Last fully real-hardware-known-good integration commit: `980bfd5e3d0239d9e7ec6b6b46b89abd1e11c0e0` (confirmed working perfectly on real PS2 on 2026-09-18). This baseline includes traversal-stable 80x80 terrain / 72x72 loc residency, compact scene allocations, lazy interface materialization, one-slot terrain texturing with water visible, corrected PS2 viewport model picking, the animated local player in normal World3D ordering, and an 18-tile camera-facing visibility wedge that extends the forward horizon while culling the old square's behind/off-screen workload.
