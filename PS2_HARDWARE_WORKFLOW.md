...
- Last fully real-hardware-known-good integration commit: `2c6fb1c8f20d92f834dce3b3b4463dcac27a707d` (confirmed working great on real PS2 on 2026-09-18). This baseline includes the prior hardware-stable scene/memory/render work, light-blue scene clear, camera-aware draw-distance culling, and the controller-native UX: tunable left-stick deadzone/cursor speed/right-stick deadzone, L3 controller settings, direct Cross primary action, Circle Options toggle, D-pad/X context-menu navigation, D-pad inventory/bank/shop grid snapping with a visible focus outline and exact cursor/click alignment, R3 as a dedicated grid-navigation escape that preserves the open interface, right-stick camera control, and L2/R2 true camera-distance zoom.
...
1. Preserve baseline `2c6fb1c8f20d92f834dce3b3b4463dcac27a707d`: qword-aligned 80x80 terrain / 72x72 loc traversal, compact scene allocations, lazy interfaces, one-slot water texture, corrected picking, animated/occluded local player, normal gameplay UI, radius-18 camera-aware visibility, the light-blue scene clear, and the real-hardware-confirmed controller-native UX including D-pad grid navigation, R3 grid escape, and true L2/R2 camera zoom.
